...
from playwright_stealth import stealth  # ✅ 方法一：采用最新版兼容导入语法
...
DP_COOKIES = os.getenv("DP_COOKIES")      # 直接注入有效 Cookie 格式的 JSON 字符串绕过鉴权
PROXY_SERVER = os.getenv("PROXY_SERVER")  # 上游代理配置 (格式示例 http://user:pass@ip:port)
